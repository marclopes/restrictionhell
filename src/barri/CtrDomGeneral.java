...
public class CtrDomGeneral {
  ...
  public static CtrDomGeneral GetInstancia() {
    if ( ctrDomini== null ) ctrDomini = new CtrDomGeneral();
    return ctrDomini;
  }
  ...
  private tipusNegoci StringNegtoEnum(String n) {
	if(n.equals("Discoteca")) return tipusNegoci.Discoteca;
  ...
  private Atribut StringToAtribut(String c) {
      if(c.equals("Alçada"));
      else if (c.equals("Cost")) return Atribut.COST;
      else if (c.equals("Distancia")) return Atribut.DISTANCIA;
      else if (c.equals("Codi1"))return Atribut.CODI1;
      else if (c.equals("Codi2"))return Atribut.CODI2;
      else if (c.equals("Edifici1")) return Atribut.EDIFICI1;
      else if (c.equals("Edifici2")) return Atribut.EDIFICI2;
      else if (c.equals("Impostos")) return Atribut.IMPOSTOS;
      else if (c.equals("Influencia")) return Atribut.INFLUENCIA;
      else if (c.equals("Quantitat"))return Atribut.QUANTITAT;
      else if (c.equals("Maxim"))return Atribut.MAXIM;
      else if (c.equals("Espai"))return Atribut.ESPAI;
      else if (c.equals("Cjt Edificis")) return Atribut.CJTEDIFICIS;
      return null;
  }
}
